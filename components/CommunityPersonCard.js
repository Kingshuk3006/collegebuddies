...
const CommunityPersonCard = () => {
  return (
    <div className="bg-[#242424] rounded-xl hover:bg-gradient-to-b from-violet via-[#2f1e36] to-[#000000] hover:scale-105 transition-all  ease-in-out flex justify-between py-2 px-4 space-x-4 max-w-[25rem]">
